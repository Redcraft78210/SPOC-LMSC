...
const liveValidationRules = () => {
    return [
        ...
        body('class').isString().isLength({ min: 3 }).withMessage('Class must be at least 3 characters long'),
        body('classSubject').isString().isLength({ min: 3 }).withMessage('Class subject must be at least 3 characters long')
    ];
};
