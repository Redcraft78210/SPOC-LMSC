...
import NavigationBar from "../../components/EleveComp/Navbar";
...
import PictureModal from "../../components/EleveComp/PictureModal";
...
DashboardEleve.propTypes = {
  content: PropTypes.oneOf(["Home", "Profile", "CoursesLibrary", "CourseReader"]).isRequired,
