...
import SecureVideoPlayer from "../../components/EleveComp/SecureVideoPlayer";
import SecureDocumentViewer from "../../components/EleveComp/SecureDocumentViewer";
...
const CourseReader = ({ authToken }) => {
    ...
    const fetchCourseData = async () => {
      try {
        ...
        const data = {
          ...
          video: {
            video_id: "video_78910", // ID unique de la vidéo
  ...
  if (error) return <div className="text-red-600 p-8">Erreur : {error}</div>;
