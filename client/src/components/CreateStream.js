    ...
    <>
      ...
      <div className="flex-col items-center justify-center p-4 bg-neutral-900 rounded-3xl">
        ...
        <form action="" onSubmit={handleSubmit} className="flex flex-col gap-2">
          <div className="">
            <label htmlFor="title" className="text-2xl bg-transparent mb-0">
              Title
            </label>
            <input
              className="bg-neutral-600 p-1 w-5/6 text-white text-xl placeholder:text-xl rounded-2xl m-auto"
              type="text"
              id="title"
          ...
          <div className="">
            <label
              htmlFor="description"
              className="text-2xl bg-transparent mb-0"
            >
              Description
            </label>
            <input
          ...
          <div>
            <label htmlFor="class" className="text-2xl bg-transparent mb-0">
              Class
            </label>
            <select
              name="class"
